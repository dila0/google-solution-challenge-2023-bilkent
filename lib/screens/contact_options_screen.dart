              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text('MESSAGE WILL BE SENT TO YOUR CONTACT AND 112 WILL BE CALLED',style:kWarningTextStyle ,textAlign: TextAlign.center,),
                    Text('${(snapshot.data == null || snapshot.data.toString() == '0') ? '5': snapshot?.data.toString()}'),
                    SizedBox(
                      height: 15,
                    ),
                    Row(
